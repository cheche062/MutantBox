package game.module.worldBoss
{
	...
	public class NpcArmyCtrl
	{
		...
		public var npcIdNameMap:Object = {
			"10001" : /*"L_A_105002"*/"食人兽",
			"10002" : /*"L_A_105003"*/"地心魔王",
			"10003" :  /*"L_A_105004"*/"天启0号"
		}
...
//			trace('【玩家等级】', npc_List);
		...
		/**改变单个顶部boss血量视图*/
		public function changeBossItemView(npcInfo:WorldBossInfoVo):void {
		...
		/**检查是否还剩一个大boss*/
		private function checkBigBossView():Boolean {
