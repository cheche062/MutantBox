package game.module.trophyRoom
{
	...
	public class TrophyRoomView extends BaseDialog
	{
		...
		private static var L_A_76108 = "L_A_76108"	//1.购买资源时，有机率出现使下次购买必定2倍或3倍暴击的事件。##2.暴击事件只在当日有效，需尽快触发。##3.当日购买资源次数越多，获得的资源数量越多。
		...
		private function onResult(...args):void{
			...
			trace("【TrophyRoomView】处理后数据:", data);
		}
		...
		override public function addEvent():void{
			...
			Signal.intance.on(ServiceConst.getServerEventKey(onError), this, onError);
		}
		...
		override public function removeEvent():void{
			...
			Signal.intance.off(ServiceConst.getServerEventKey(onError), this, onError);
		}
